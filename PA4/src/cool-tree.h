...
#define Expression_SHARED_EXTRAS_NEW         \
  void code(ostream&, Context);                    \
void dump_with_types(ostream&,int); 

#define Expression_EXTRAS_NEW                    \
Symbol type;                                 \
...
#ifdef Expression_EXTRAS_NEW
   Expression_EXTRAS_NEW
#endif
};
...
#ifdef Expression_SHARED_EXTRAS_NEW
   Expression_SHARED_EXTRAS_NEW
#endif
#ifdef assign_EXTRAS
   assign_EXTRAS
#endif
