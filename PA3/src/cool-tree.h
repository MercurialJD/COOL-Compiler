...
public:
   ...
   virtual unordered_map<Symbol, Feature>& getMethods() { return methods; }
   virtual unordered_map<Symbol, Feature>& getAttrs() { return attrs; }
